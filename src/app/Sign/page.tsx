    ...
    <div >
      <div className='Sign'>
        ...
        <div className='SignUp'>
         ...
         <div className='input'>
         <div className='label '>
         <input type="text" placeholder='Name' className='border-b-2 border-slate-300 outline-none text-black w-full text-xl' />
         ...
         <button className='text-[16px] py-[16px] bg-[#DB4444] transition-all duration-200 hover:bg-[#f36262] rounded w-[80%]'>Create Account</button>
         <button className='text-black text-[16px] flex justify-center items-center gap-3 text-nowrap bg-transparent border-2 border-slate-400 w-[80%]  py-[16px]'><FaGoogle className='text-[20px]'/>Sign up with Google</button>
         <div className='flex gap-3 text-[16px] '>
          <p className='text-slate-600 '>Already have account?</p>
          <Link
          href="/Login">
          <p className='text-black hover:underline'>Log in</p>
          </Link>
         </div>
         </div>
         </div>
